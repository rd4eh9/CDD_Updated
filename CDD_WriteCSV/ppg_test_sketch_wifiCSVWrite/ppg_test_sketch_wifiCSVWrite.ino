...
const int resPin = 1;
const int mfioPin = 2;
String testType = "se"; // wi for wifi, se for serial monitor
...
// Update below !!!!!
const char* ssid = "Noah's iPhone 17 Pro";
const char* password = "supersecret";
String googleSheetScriptURL = "https://script.google.com/macros/s/AKfycbx6T9sFylCjD_9J25aQh9N1kFJYBVwytyYwlXdP4bRyJIi1mKDIrTZdaZekHxzku-qU/exec";
// script:
// function doGet(e) {
